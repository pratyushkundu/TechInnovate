...
//     {
//       rating: 4.4,
//       content: "Hukitola completely transformed our digital presence. The AI integration has automated 40% of our customer service inquiries, and our conversion rates have increased by 50%.",
//       name: "Lars Rodreguez",
//       role: "CEO,RBA chain",
//       initials: "LL"
//     },
...
//       name: "Anand Mehta",
//       role: "Project Manager, Zolutech",
//       initials: "AM"
//     },
//     {
//       rating: 4,
//       content: "Outstanding mobile app development! The user interface is intuitive, and the performance is flawless. Our user retention has increased by 60% since launch.",
//       name: "Amanda Johnson",
...
//     {
//       rating: 4.1,
//       content: "Outstanding web app development! The user interface is intuitive, and the performance is flawless. Our user retention has increased by 60% since launch.",
//       name: "Rishab Sharma",
//       role: "Product Manager, Awww",
//       initials: "RS"
//     }
//   ];
  ...
  const testimonials = [
    {
      rating: 4.4,
      content:
        "Hukitola completely transformed our digital presence. The AI integration has automated 40% of our customer service inquiries, and our conversion rates have increased by 50%.",
      name: "Lars Rodreguez",
      role: "CEO, RBA chain",
      initials: "LL",
    },
    {
      rating: 4.3,
      content:
        "The tech migration was seamless, and our CRM system performance has improved dramatically. Their 24/7 support team is incredibly responsive and knowledgeable.",
      name: "Anand Mehta",
      role: "Project Manager, Zolutech",
      initials: "AM",
    },
    {
      rating: 4,
      content:
        "Outstanding mobile app development! The user interface is intuitive, and the performance is flawless. Our user retention has increased by 60% since launch.",
      name: "Amanda Johnson",
      role: "Product Manager, Techflow Solutions",
      initials: "AJ",
    },
    {
      rating: 4.1,
      content:
        "Outstanding web app development! The user interface is intuitive, and the performance is flawless. Our user retention has increased by 60% since launch.",
      name: "Rishab Sharma",
      role: "Product Manager, Awww",
      initials: "RS",
    },
    ...
    <section id="testimonials" className="py-20 bg-gradient-hero">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p
            className="text-xl text-slate-300 dark:text-slate-300 max-w-3xl mx-auto"
            data-testid="testimonials-description"
          >
            Hear from our satisfied clients about their transformative
            experiences with TechFlow Solutions.
          </p>
        </div>
            ...
            >
              <CardContent className="p-8">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <span className="ml-3 text-slate-300 dark:text-slate-300">
                ...
                {/* Content */}
                <p
                  className="text-slate-300 dark:text-slate-300 mb-6 leading-relaxed"
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-tech rounded-full flex items-center justify-center mr-4">
                    <span
                      ...
                      data-testid={`testimonial-initials-${index}`}
                    >
                      {testimonial.initials}
                    </span>
                  </div>
                  <div>
                    ...
                    <div
                      className="text-sm text-slate-400 dark:text-slate-400"
