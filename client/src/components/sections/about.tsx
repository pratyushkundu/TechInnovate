...
//   );
// }
import pratimg from './../../assets/pratyush.jpg';
import siddimg from '../../assets/siddhant.jpg';
export default function About() {
  return (
    <section id="about" className="py-20 bg-gradient-hero">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div data-testid="stat-awards">
                <h3 className="text-2xl font-bold text-tech-purple mb-2">50+ Projects</h3>
                <p className="text-slate-400 dark:text-slate-400">Successfully Delivered</p>
              </div>
              <div data-testid="stat-uptime">
            ...
            {[
              {
                ...
                image: pratimg,
                expertise: ["AI/CRM", "FullStack/Blockchain", "DevOps", "Team Leadership"]
              },
              {
                name: "Siddhant Das",
                role: "Content Strategist & Videography Manager",
                image: siddimg,
                expertise: ["Cinematography", "Counsellor"]
              },
              {
                name: "Ionsu Muduli",
                role: "Lead Developer & Data Engineer",
                // image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400",
                expertise: ["AI", "Shopify/WordPress", "Data Science", "Analytics", "Machine Learning"]
              },
